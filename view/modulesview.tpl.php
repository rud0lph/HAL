...
<div class="page-header">
  <h1>Module: <?=$module['name']?> <small></small></h1>
</div>
...
<tbody>
  <tr><td>Part of Hal Core modules</td><td><?=$module['isHalCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of Hal CMF modules</td><td><?=$module['isHalCMF']?'Yes':'No'?></td></tr>
