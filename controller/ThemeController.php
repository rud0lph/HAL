...
* @package HalCore
*/
class ThemeController extends Controller implements IController {
  ...
  public function Index() {
    ...
    $this->views->SetTitle('Theme')
                ->AddInclude(HAL_INSTALL_PATH. '/view/theme.tpl.php', array(
  ...
  public function H1H6() {
    $this->views->SetTitle('Theme testing headers and paragraphs')
                ->AddInclude(HAL_INSTALL_PATH. '/view/h1h6.tpl.php', array(), 'primary');
  }
