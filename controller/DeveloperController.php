 ...
 * @package HalCore
 */
class DeveloperController extends Controller implements IController {
  ...
  public function Index() {  
	...
	/**
 	 * Display all items of the Controller object.
	 */
	public function DisplayObject() {	
		$this->Menu();

		$this->data['main'] .= <<<EOD
<h2>Dumping content of Developer</h2>
<p>Here is the content of the controller, including properties from Controller object which holds access to common resources in Hal.</p>
EOD;
