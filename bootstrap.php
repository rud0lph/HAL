...
function autoload($aClassName) {
	...
	//Load form classes
	} elseif (preg_match('/Form/', $aClassName)){//strpos($aClassName, 'Form')) {//substr($aClassName, -strlen('Form')) === 'Form') {
		$classFile = "/form/{$aClassName}.php";	
	//Load HTMLPurifier
	} elseif (substr($aClassName, -strlen('HTMLPurifierWrapper')) === 'HTMLPurifierWrapper') {
		$classFile = "/HTMLPurifier/{$aClassName}.php";	
	} else {
	//Load core files
